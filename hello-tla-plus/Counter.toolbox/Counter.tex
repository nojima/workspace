...
\fl{}\moduleLeftDash\cl{ {\MODULE} Counter}\moduleRightDash\cl{}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, FiniteSets}
\fl{}
\fl{}
\fl{ {\CONSTANT} procs}
\fl{}
...
\fl{}
\fl{ Init \.{\defeq}}
\fl{ \.{\land}}\al{20}{1}{ pc \.{=} [ p \.{\in} procs \.{\mapsto}\@w{read} ]}
\fl{ \.{\land}}\al{21}{1}{ memory \.{=} [ p \.{\in} procs \.{\mapsto} 0 ]}
\fl{ \.{\land}}\al{22}{1}{ count \.{=} 0}
\fl{}
\fl{}
\fl{ ReadStep ( p ) \.{\defeq}}
\fl{ \.{\land}}\al{26}{1}{ pc [ p ] \.{=}\@w{read}}
 \fl{ \.{\land}}\al{27}{1}{ memory \.{'} \.{=} [ memory {\EXCEPT} {\bang} [ p
 ] \.{=} count ]}
 \fl{ \.{\land}}\al{28}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{write} ]}
\fl{ \.{\land}}\al{29}{1}{ {\UNCHANGED} {\langle} count {\rangle}}
\fl{}
\fl{}
\fl{ WriteStep ( p ) \.{\defeq}}
\fl{ \.{\land}}\al{33}{1}{ pc [ p ] \.{=}\@w{write}}
\fl{ \.{\land}}\al{34}{1}{ count \.{'} \.{=} memory [ p ] \.{+} 1}
 \fl{ \.{\land}}\al{35}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{done} ]}
\fl{ \.{\land}}\al{36}{1}{ {\UNCHANGED} {\langle} memory {\rangle}}
\fl{}
\fl{}
\fl{ DoNothing ( p ) \.{\defeq}}
\fl{ \.{\land}}\al{40}{1}{ pc [ p ] \.{=}\@w{done}}
 \fl{ \.{\land}}\al{41}{1}{ {\UNCHANGED} {\langle} pc ,\, memory ,\, count
 {\rangle}}
\fl{}
\fl{}
\fl{ Increment ( p ) \.{\defeq}}
\fl{ \.{\lor}}\al{45}{1}{ ReadStep ( p )}
\fl{ \.{\lor}}\al{46}{1}{ WriteStep ( p )}
\fl{ \.{\lor}}\al{47}{1}{ DoNothing ( p )}
\fl{}
\fl{ Next \.{\defeq}}
\fl{ \E\, p \.{\in} procs \.{:} Increment ( p )}
\fl{}
\fl{}\midbar\cl{}
\fl{}
\fl{ AllProcessIsDone \.{\defeq}}
\fl{ \A\, p \.{\in} procs \.{:} pc [ p ] \.{=}\@w{done}}
\fl{}
\fl{}
\fl{ PostCondition \.{\defeq}}
\fl{ AllProcessIsDone \.{\implies} count \.{=} Cardinality ( procs )}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
