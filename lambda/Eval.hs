...
data EvalError
    = EvalError Syntax.Location String
    deriving (Show)
...
getLocation :: Syntax.Term -> Syntax.Location
getLocation term =
    case term of
        Syntax.True_  loc       -> loc
        Syntax.False_ loc       -> loc
        Syntax.If     loc _ _ _ -> loc
        Syntax.Zero   loc       -> loc
        Syntax.Succ   loc _     -> loc
        Syntax.Pred   loc _     -> loc
        Syntax.IsZero loc _     -> loc
